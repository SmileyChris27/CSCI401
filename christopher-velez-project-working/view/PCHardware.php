  ...
  <div class="site">
    ...
    <center>
      <form action='index.php' method='GET'>
          ...
          <input type='hidden' name='choice' value='products' />
          <input style="background-color: black; color: green;" type='submit' name='choice2' value='$350.00' class="addToCart" onclick="alert('CPU is in the cart please proceed to cart to check out ...')"/>
      </center>
